...
//             <Link to="/view-swap" className="nav-link">My Enrollments</Link>
...
const SwapSkillsLandingPage = () => {
  ...
  const handleCreateSwap = () => navigate('/create-swap');
  const handleJoinSwap = () => navigate('/join-swap');
  const handleJoinNow = () => navigate('/mentored-courses');
  ...
  return (
    <div className="landing-container">
      <header className="main-header">
        <div className="skill-header-content">
          <div className="logo-container">
            <div className="logo-icon"><img src={logoImage} alt="SkillUp Logo" /></div>
            <span className="logo-text">SkillUp</span>
          </div>
          <nav className="main-navigation">
            <a href="#" className="nav-link">Home</a>
      ...
      <main className="skill-hero-section">
        <div className="skill-hero-content">
          <div className="skill-hero-text-container">
            <h1>{greeting} {authUser?.name || "User"},</h1>
            <h2 className="skill-hero-heading"><br />Welcome to Our <br />Skill Swapping<br />Platform</h2>
            <h3 className="skill-hero-subheading">Discover a world of opportunities by swapping your skills with others</h3>
            <div className="skill-hero-buttons">
              <button className="get-started-button" onClick={handleCreateSwap}>Create A Swap</button>
              <button className="explore-skills-button" onClick={handleJoinSwap}>Join A Swap</button>
            </div>
          </div>
          <div className="greeting-image"><img src="/avatar1.png" alt="Welcome" /></div>
        </div>
        ...
        <section ref={faqRef} className="faq-section">
          ...
          <div className="faq-item"><h3>What is Skill Swapping?</h3><p>Skill Swapping is a platform where you can exchange your skills with others to learn and grow together.</p></div>
          <div className="faq-item"><h3>How do I create a swap?</h3><p>You can create a swap by clicking the "Create A Swap" button and following the instructions.</p></div>
          <div className="faq-item"><h3>Is there a fee to join?</h3><p>Basic skill swapping is free, but mentor-led courses require payment. Users can also earn credits by teaching others.</p></div>
          <div className="faq-item"><h3>Who can join SkillUp?</h3><p>Anyone interested in learning and sharing skills is welcome to join SkillUp.</p></div>
        </section>

        <section ref={contactUsRef} className="contactus-section">
          <h2>Contact Us</h2>
          <div className="contactus-item"><h3>Get in Touch</h3><p>Reach us at contact@skillup.com or call (+91) 9830070661.</p></div>
          <div className="contactus-item"><h3>Office Location</h3><p>Heritage Institute of Technology, Kolkata</p></div>
          <div className="contactus-item"><h3>Follow Us</h3>
            <p>LinkedIn <a href="https://www.linkedin.com/in/aryan-ghosh-83a26631b" target="_blank" rel="noopener noreferrer"><FaLinkedin style={{ color: 'white' }} /></a> 
            Instagram <a href="https://www.instagram.com/aryanghosh_4960" target="_blank" rel="noopener noreferrer"><FaInstagram style={{ color: 'white' }} /></a> 
            Twitter <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer"><FaTwitter style={{ color: 'white' }} /></a></p>
          </div>
        </section>
      </main>
    </div>
