...
const MentorSkillSwapLandingPage = () => {
  const [greeting, setGreeting] = useState('');
  const navigate = useNavigate();
  const faqRef = useRef(null);
  ...
  return (
    <div className="landing-container">
      ...
      <main className="skill-hero-section">
        <div className="skill-hero-content">
          <div className="skill-hero-text-container">
            <h1>{greeting} {authUser?.name || "Mentor"},</h1>
            <h2 className="skill-hero-heading">
              <br />Welcome to SkillUp!!
            </h2>
            <h3 className="skill-hero-subheading">
              Ready to Inspire and Transform Lives?<br />
              Teach what you love, inspire others, and turn your expertise into impact—
              SkillUp empowers you to shape the future, one learner at a time!!
            </h3>
            <div className="skill-hero-buttons">
              <button className="get-started-button" onClick={handleCreateCourse}>Create A Course</button>
            </div>
        ...
        <section ref={faqRef} className="faq-section">
          ...
          <div className="faq-item">
            <h3>Can I mentor multiple courses?</h3>
            <p>Yes! You can create and manage multiple courses from your mentor dashboard anytime.</p>
          </div>
        </section>
        ...
        <section ref={contactUsRef} className="contactus-section">
          ...
          <div className="contactus-item"><h3>Follow Us</h3>
            <p>
              LinkedIn <a href="https://www.linkedin.com/in/aryan-ghosh-83a26631b" target="_blank" rel="noopener noreferrer"><FaLinkedin style={{ color: 'white' }} /></a> 
              ...
              Twitter <a href="https://www.twitter.com" target="_blank" rel="noopener noreferrer"><FaTwitter style={{ color: 'white' }} /></a>
            </p>
          </div>
        </section>
      </main>
...
export default MentorSkillSwapLandingPage;
